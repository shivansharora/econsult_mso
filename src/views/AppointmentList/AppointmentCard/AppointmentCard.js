    ...
    >
      <CardContent className={classes.content}>
        ...
        <div className={classes.stats}>
          ...
          <Typography style={{ fontSize: 'unset', fontWeight: 300 }} variant="h6">{project.category}</Typography>

        </div>
        <div className={classes.stats}>
          <Typography style={{ fontWeight: 500 }} variant="body2">Status</Typography>
          <Typography style={{ fontSize: 'unset', fontWeight: 300 }} variant="h6">{project.status}</Typography>

        </div>
        <div className={classes.stats}>
          <Typography style={{ fontWeight: 500 }} variant="body2">Appointment Date and Time </Typography>
          <Typography style={{ fontSize: 'unset', fontWeight: 300 }} variant="h6">
